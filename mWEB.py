    ...
    if "dados" in st.session_state and "tipo_teste" in st.session_state:
        ...
        if tipo_teste == "TUG":
            ...
            with col1:
                ...
                st.metric(label=r"Tempo para entre o giro e descida na cadeira (s)", value=round(G4_lat-G2_lat, 4))
                st.metric(label=r"Diferença de G4 e A2  (s)", value=round(G4_lat-A2_lat, 4))
