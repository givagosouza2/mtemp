...
# === Página de Visualização Gráfica ===
    ...
    if "dados" in st.session_state and "tipo_teste" in st.session_state:
        ...
        if tipo_teste == "TUG":
            ...
            t_novo_acc, x_acc_filtrado, y_acc_filtrado, z_acc_filtrado, norma_acc_filtrado, t_novo_gyro, x_gyro_filtrado, y_gyro_filtrado, z_gyro_filtrado, norma_gyro_filtrado = tugProcessing.processar_tug(dados_acc,dados_gyro,4)
            with col2:
