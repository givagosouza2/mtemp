        ...
        if tipo_teste == "Y test":
            ...
            with col2:
                ...
                if showRec:
                    ...
                    tempo_sel_2[startRec:endRec], ml_2_sel_media[startRec:endRec], color='blue', linewidth=0.8)
                ...
                if showRec:
                    ...
                    tempo_sel_2[startRec:endRec], v_2_sel_media[startRec:endRec], color='blue', linewidth=0.8)
